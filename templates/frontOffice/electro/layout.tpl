...
<head>
    ...
    *}
    ...
    <body class="{block name="body-class"}{/block}" itemscope itemtype="http://schema.org/WebPage">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="mb-8 mb-xl-0">
                                <div class="mb-6"><img src="{image file='assets/images/icons/clock.svg'}" alt="" /></div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="mb-8 mb-xl-0">
                                <div class="mb-6"><img src="{image file='assets/images/icons/gift.svg'}" alt="" /></div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="mb-8 mb-xl-0">
                                <div class="mb-6"><img src="{image file='assets/images/icons/package.svg'}" alt="" /></div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="mb-8 mb-xl-0">
                                <div class="mb-6"><img src="{image file='assets/images/icons/refresh-cw.svg'}" alt="" /></div>
                ...
                <footer class="footer-info" role="contentinfo">
                    <div class="container">
                        <div class="info row">
                            ...
                            <div class="col-lg-3">
                                <section class="copyright">{intl l="Copyright"} &copy; <time
                                        datetime="{'Y-m-d'|date}">{'Y'|date}</time> <a href="http://thelia.net"
                                        rel="external">Thelia</a></section>
                            </div>
                        </div>
                    </div>
                </footer>
        ...
        <script>
            if(typeof($.fn.modal) === 'undefined') { document.write('<script src="{$asset_url}"><\/script>'); }
        </script>
        {/javascripts}
