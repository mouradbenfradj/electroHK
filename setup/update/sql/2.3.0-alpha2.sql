...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `description`, `chapo`, `postscriptum`) VALUES
    ...
    (@max_id + 2, 'ru_RU', NULL, NULL, NULL, NULL),
    (@max_id + 3, 'ru_RU', NULL, NULL, NULL, NULL),
...
INSERT INTO  `hook_i18n` (`id`, `locale`, `title`, `description`, `chapo`) VALUES
    ...
    (@max_id+10, 'ru_RU', NULL, NULL, NULL),
    (@max_id+11, 'ru_RU', NULL, NULL, NULL),
    (@max_id+12, 'ru_RU', NULL, NULL, NULL),
    (@max_id+13, 'ru_RU', NULL, NULL, NULL),
    (@max_id+14, 'ru_RU', NULL, NULL, NULL),
    (@max_id+15, 'ru_RU', NULL, NULL, NULL),
    (@max_id+16, 'ru_RU', NULL, NULL, NULL),
...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (@max+1, 'ru_RU', NULL, NUll, NULL, NULL),
    (@max+2, 'ru_RU', NULL, NUll, NULL, NULL),
    (@max+3, 'ru_RU', NULL, NUll, NULL, NULL),
