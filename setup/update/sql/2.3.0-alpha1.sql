...
INSERT INTO  `hook_i18n` (`id`, `locale`, `title`, `description`, `chapo`) VALUES
    ...
    (@max_id+17, 'ru_RU', NULL, NULL, NULL),
    (@max_id+18, 'ru_RU', NULL, NULL, NULL),
    (@max_id+19, 'ru_RU', NULL, NULL, NULL),
    (@max_id+20, 'ru_RU', NULL, NULL, NULL),
    (@max_id+21, 'ru_RU', NULL, NULL, NULL),
    (@max_id+22, 'ru_RU', NULL, NULL, NULL),
    (@max_id+23, 'ru_RU', NULL, NULL, NULL),
    (@max_id+24, 'ru_RU', NULL, NULL, NULL),
    (@max_id+25, 'ru_RU', NULL, NULL, NULL),
    (@max_id+26, 'ru_RU', NULL, NULL, NULL),
    (@max_id+27, 'ru_RU', NULL, NULL, NULL),
...
INSERT INTO `country_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (@max_id + 4, 'ru_RU', NULL, NULL, NULL, NULL),
    (@max_id + 5, 'ru_RU', NULL, NULL, NULL, NULL),
    (@max_id + 6, 'ru_RU', NULL, NULL, NULL, NULL),
    (@max_id + 7, 'ru_RU', NULL, NULL, NULL, NULL),
